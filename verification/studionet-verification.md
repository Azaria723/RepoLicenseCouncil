...
`0xfEa116bEa66ba7FF6F7Cc4573c949a22f2Fc1665`.
...
|---|---|---|
| Create council | `0xd6ba0e0e2a16d536f27581ef64237307c400536162795fcb0f33b55af8b38983` | Council 0, two members, quorum 2 |
| Propose change | `0xcfaabc6b8bcdb44827eef71a800cb00885ddd03781a3c8d8cf1159815b4c455c` | Case 0 created from two immutable revisions |
| Assess change | `0xebcb4469028a59d98378ea3d436a72ad85be7cb4ab23a2b2f7df39cf3d1548c1` | Provenance true; `MORE_RESTRICTIVE`; characteristic `network-copyleft` |
| First ballot | `0x0e624d5f3436efd8fcbb00cf3b6b52450465914d523ec3c0fce2db8872beaad4` | `ACCEPT`; total becomes 1 |
| Duplicate ballot attempt | `0x5ac49bb60b7b77631fe6746e3318141a6f25f2bbc13ec11e57255877da3ed34b` | Protected state unchanged |
| Premature finalize attempt | `0xdb1fda100168e3a573ee8d019f9f73fb19c542973fb20e23ca908eb60a8994b9` | Decision remains `PENDING` below quorum |
| Second ballot | `0x050a1f25910d4ad4c722c7ba9475518cb11c368a25d6bc4a509381bdec286b04` | `REJECT`; total becomes 2 |
| Finalize | `0xece1ec993a3acbde86b01d5a165c47544d652214be51b7945b19b891f364f9a2` | Tie deterministically resolves to `REJECTED` |
